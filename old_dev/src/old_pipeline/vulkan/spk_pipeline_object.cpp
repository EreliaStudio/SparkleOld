...
#include "graphics/pipeline/vulkan/spk_pipeline_basic_functions.hpp"

namespace spk
{
	Pipeline::VulkanObject::VulkanObject(spk::AbstractPipeline* p_owner,
	...
	std::vector<vk::VertexInputBindingDescription> Pipeline::VulkanObject::bindingDescriptions(const spk::ShaderLayout::StorageLayout& p_storageConfiguration)
	{
	...
	std::vector<vk::VertexInputAttributeDescription> Pipeline::VulkanObject::attributeDescriptions(const spk::ShaderLayout::StorageLayout& p_storageConfiguration)
	{
