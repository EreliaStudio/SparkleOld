...
public:
        ...
        spk::Widget(p_name)
    {
        ...
        _gameEngineManager = new spk::GameEngineManager(L"GameEngineManager");
        addChild(_gameEngineManager);
...
int main()
{
    spk::Application app(L"Playground", 900, true);

    MainWidget mainWidget(L"MainWidget");
