...
namespace spk
{
	...
	{
	private:
		spk::Server _server; /**< Server object for network communication */
		std::map<spk::Message::Type, Node*> _messagesRedirection; /**< Map to store the mapping of message types to corresponding nodes */
