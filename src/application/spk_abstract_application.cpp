...
namespace spk
{
	spk::ContractProvider::Contract AbstractApplication::addJob(const std::wstring &p_WorkerName, const AbstractApplication::Job& p_job)
	{
	...
	spk::ContractProvider::Contract AbstractApplication::addJob(const AbstractApplication::Job& p_job)
	{
