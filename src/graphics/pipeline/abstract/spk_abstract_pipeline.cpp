...
namespace spk
{
	...
	std::shared_ptr<AbstractPipeline::Uniform> AbstractPipeline::uniform(const std::wstring& p_uniformName)
	{
	...
	std::shared_ptr<AbstractPipeline::Uniform> AbstractPipeline::uniform(const ShaderLayout::UniformBlockLayout::Key& p_uniformKey)
	{
